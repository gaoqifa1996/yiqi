...
def xml_head():
    ...
    prc_sst_world = doc.createElement("PRC_SST_WORLD")
    body.appendChild(prc_sst_world)
    ...
    kident.setAttribute("plant", "")
    kident.setAttribute("componentnumber", "")
    kident.setAttribute("id", "")
    kident.setAttribute("serial", "")
    kident.setAttribute("checkdigit", "")
...
def xml_eol():
    ...
    application.setAttribute("name", "SDV")
    application.setAttribute("manufacturer", "Chroma")
    application.setAttribute("uri", "")
    application.setAttribute("majorversion", "1")
    application.setAttribute("minorversion", "0")
